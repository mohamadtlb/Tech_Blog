...
class $AssetsIconsGen {
  ...
  /// File path: assets/icons/dawn_cat_arrow.png
  AssetGenImage get dawnCatArrow =>
      const AssetGenImage('assets/icons/dawn_cat_arrow.png');
  ...
  /// File path: assets/icons/manage_article_icon.png
  AssetGenImage get manageArticleIcon =>
      const AssetGenImage('assets/icons/manage_article_icon.png');

  /// File path: assets/icons/manage_podcast_icon.png
  AssetGenImage get managePodcastIcon =>
      const AssetGenImage('assets/icons/manage_podcast_icon.png');
...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/peofile_avatar.png
  ...
  SvgGenImage get techBotSvg =>
      const SvgGenImage('assets/images/techBot.svg.svg');
}
