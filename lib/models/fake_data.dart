...
List<PodcastModel> podcastList = [
  PodcastModel(podImageUrl: Assets.images.ramzon.path, podTitle: "رمزون"),
  PodcastModel(
      podImageUrl: Assets.images.radiopodcast.path, podTitle: "رادیو کدیاد"),
  PodcastModel(podImageUrl: Assets.images.teccast.path, podTitle: "تکنو کست"),
  PodcastModel(podImageUrl: Assets.images.podicast.path, podTitle: "پادی کست"),
];
